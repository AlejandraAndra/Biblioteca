...
public class Trabajador {
    ...
    public Trabajador(int ID_Trabajador, String Nombre_Trabajador, String Apellido_Paterno, String Apellido_Materno, String Direccion_Trabajador, String Correo_Electronico, String Fech_Contrato) {
        this.ID_Trabajador = ID_Trabajador;
        this.Nombre_Trabajador = Nombre_Trabajador;
        this.Apellido_Paterno = Apellido_Paterno;
        this.Apellido_Materno = Apellido_Materno;
